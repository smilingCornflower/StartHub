...
class DjCompanyReadRepository(CompanyReadRepository):
    ...
    def get_all(
        self, filter_: CompanyFilter, pagination: CursorPagination | OffsetPagination | None = None
    ) -> list[Company]:
...
class DjCompanyWriteRepository(CompanyWriteRepository):
    def create(self, data: CompanyCreatePayload) -> Company:
        return Company.objects.create(
            ...
            patent_number=data.patent_number.value if data.patent_number else None,
        )
...
class DjCompanyFounderReadRepository(CompanyFounderReadRepository):
    ...
    def get_all(
        self, filter_: CompanyFounderFilter, pagination: CursorPagination | OffsetPagination | None = None
    ) -> list[CompanyFounder]:
