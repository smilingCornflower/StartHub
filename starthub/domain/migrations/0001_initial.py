# Generated by Django 5.2.1 on 2025-06-13 12:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "first_name",
                    models.CharField(
                        max_length=50, validators=[django.core.validators.RegexValidator(re.compile("^[\\w_-]+$"))]
                    ),
                ),
                (
                    "last_name",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("description", models.TextField()),
                ("company", models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to="domain.company")),
            ],
            options={
        ...
        migrations.AddField(
            model_name="company",
            name="country",
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to="domain.country"),
        ),
        migrations.CreateModel(
            name="Project",
            fields=[
        ...
        migrations.AddField(
            model_name="company",
            name="project",
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to="domain.project"),
        ),
        migrations.CreateModel(
            name="TeamMember",
            fields=[
