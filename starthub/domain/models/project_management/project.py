...
class Project(BaseModel):
    ...
    slug = AutoSlugField(populate_from="name", unique=True, max_length=CHAR_FIELD_MAX_LENGTH + 10)
    ...
    stage = models.ForeignKey("domain.ProjectStage", on_delete=models.PROTECT, related_name="projects")
