...
from domain.constants import CHAR_FIELD_MAX_LENGTH, PROJECT_CROWDFUNDING_AMOUNT_MAX_DIGITS
...
class ProjectCrowdfunding(BaseModel):
    ...
    amount = models.DecimalField(max_digits=PROJECT_CROWDFUNDING_AMOUNT_MAX_DIGITS, decimal_places=2)
